                            ...
                            <div class="col-md-12">
                                ...
                                @endforeach
                                    <div class="form-group">
                                        <label class="control-label">المدينة التابع لها</label>
                                        {{ Form::select('city_id', $cities, null, array('class' => 'form-control select2 select2-hidden-accessible','tabindex'=>-1,'aria-hidden'=>true)) }}
