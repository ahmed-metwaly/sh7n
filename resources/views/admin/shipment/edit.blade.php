                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @endforeach
                                <div class="form-group">
                                    ...
                                    {{ Form::select('shipment_type_id', $shipment_types, $row->shipment_type_id, array('class' => 'form-control select2 select2-hidden-accessible','tabindex'=>-1,'aria-hidden'=>true)) }}
                                            ...
                                            <div class="form-group">
                                                <label for="title">{{$package_type->name}}</label>
                                                    ...
                                                    @if(in_array($package_type->id,$package_type_ids))
                                                        @php
                                                            $shipment_package_count=App\Models\ShipmentPackage::where(['shipment_id'=>$row->id,'package_type_id'=>$package_type->id])->value('count');
                                                        @endphp
                        ...
                        <div class="col-md-6">
                            <div class="white-box">
                                ...
                                <input name="image" type="file"  id="input-file-now-custom-1" class="dropify" @if($row->image)  data-default-file="{{url('public/images/shipment/'.$row->image)}}" @else data-default-file="{{url('public/images/purchase/default.jpg')}}"  @endif/>
                                @if ($errors->has('image'))
