                                    ...
                                    {{--@if($row->image==null)--}}
                                        ...
                                        <td class="actions">
                                            <div class="row" style="margin-top: 20px">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="{{route($route.'.show_receipt',$row->id)}}">
                                                        <button type="button" class="btn btn-success btn-custom waves-effect waves-light">فاتورة الاستﻻم</button>
                                                    </a>
                                                </div>
                                               
                                                <div class="col-md-4">
                                                    <a href="{{route($route.'.show_sent',$row->id)}}">
