                    ...
                    <div class="card-box border-none">
                       ...
                       <div class="row voice-border p-2 d-flex align-items-center">
                            ...
                            <div class="col-xs-6 mt-46 text-center">
                                <p>التاريخ :  {!! date('Y-m-d', strtotime($row->created_at))  !!} م</p>
                                <p>الموافق :  
                        ...
                        <div class="col-xs-8">
                            <div class="row voice-border p-3 mt-5">
                                <div class="col-xs-12">
                                    <p>اسم المرسل  :   {!! $row->sender_name !!}</p>
                                    <p>هاتف المرسل : {!! $row->sender_phone !!}</p>
                                    <p>رقم هوية المرسل : {!! $row->sender_identity !!}</p>
                                </div>
                            </div>
                            <div class="row voice-border p-3">
                                <div class="col-xs-6">
                                    <p>اسم المستلم : {!! $row->mediator_name !!}   </p>
                                    <p>رقم الهوية : {!! $row->mediator_identity !!}</p>
                                </div>
                                <div class="col-xs-6">
                                    <p>الهاتف : {!! $row->mediator_phone !!}</p>
                                </div>
                            </div>
                            <div class="row voice-border p-3">
                                <div class="col-xs-12">
