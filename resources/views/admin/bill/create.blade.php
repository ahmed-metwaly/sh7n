                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {{ Form::select('type', $type, null, array('class' => 'form-control select2 select2-hidden-accessible','tabindex'=>-1,'aria-hidden'=>true, 'required')) }}
                                    @if ($errors->has('type'))
                            ...
                            <div class="col-md-6">
                                <div class="white-box">
                                    ...
                                    <input name="image" type="file" id="input-file-now-custom-1" class="dropify" data-default-file="{{url('public/images/bill/default.jpg')}}"/>
                                    @if ($errors->has('image'))
