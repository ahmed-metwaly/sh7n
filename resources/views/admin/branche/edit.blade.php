                    ...
                    <div class="row">
                        <div class="col-md-6">
                            @foreach($languages as $language)
                                <div class="form-group">
                                    ...
                                    @php $title=\App\Models\BrancheDescription::where(['language_id'=>$language->id,'branche_id'=>$row->id])->value('title'); @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    @php $address=\App\Models\BrancheDescription::where(['language_id'=>$language->id,'branche_id'=>$row->id])->value('address'); @endphp
                                    {!! Form::text('address_'.$language->label, $address, ['class'=>'form-control','required']) !!}
                                    @if ($errors->has('address_'.$language->label))
                                        <small class="text-danger">{{ $errors->first('name_'.$language->label) }}</small>
                                    @endif
                                </div>
                            @endforeach
                        ...
                        <div class="form-group">
                            <div class="fileupload btn btn-purple waves-effect waves-light">
                                <span><i class="ion-upload m-r-12"></i>صورة الفرع</span>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('mobile', $row->mobile, ['class'=>'form-control']) !!}
                        ...
                        {{--<div class="col-md-6">--}}
                            {{--<div class="white-box">--}}
                                ...
                                {{--<input name="image" type="file" id="input-file-now-custom-1" class="dropify" @if($row->image) data-default-file="{{url('public/images/branche/'.$row->image)}}" @else data-default-file="{{url('public/images/branche/default.png')}}"  @endif/>--}}
                                {{--@if ($errors->has('image'))--}}
                                    {{--<small class="text-danger">{{ $errors->first('image') }}</small>--}}
                                {{--@endif--}}
                            {{--</div>--}}
