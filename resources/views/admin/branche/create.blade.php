            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        ...
                        {!! Form::open(['method'=>'post', 'files'=>true, 'enctype' => 'multipart/form-data', 'route'=>['branche-add'], 'class' => 'form-row-seperated add_ads_form']) !!}
                            ...
                            <div class="col-md-12">
                                @foreach($languages as $language)
                                    <div>
                                        ...
                                        {!! Form::text('address_'.$language->label, null, ['class'=>'form-control']) !!}
                                        @if ($errors->has('address_'.$language->label))
                                            <small class="text-danger">{{ $errors->first('address_'.$language->label) }}</small>
                                        @endif
                                    </div>
                                @endforeach
                                    <div>
                                    ...
                                    <div class="form-group">
                                        <div class="fileupload btn btn-purple waves-effect waves-light">
                                            <span><i class="ion-upload m-r-12"></i>صور الفرع</span>
                                            <input class="upload" type="file" accept="image/*" name="image" />
