                                    ...
                                    {{--@if($row->image==null)--}}
                                        ...
                                        <td class="actions">
                                            <div class="row" style="margin-top: 20px">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="<?php echo url('/'); ?>/admin/out-shipment/sheet/print/?office={{ $row->office_id }}&car={{ $row->car_number }}">
                                                        <button type="button" class="btn btn-success btn-custom waves-effect waves-light">فاتورة إرسال</button>
                                                    </a>
                                                </div>
